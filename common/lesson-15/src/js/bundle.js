...
/*!*******************************!*\
  ...
  \*******************************/
/*! no static exports found */function(e,o){e.exports=function(){var e=function(e){return e<10&&(e="0"+e),e},o=function(e){var o,s,t,n=Date.parse("2018-11-5")-Date.parse(new Date)+60*(new Date).getTimezoneOffset()*1e3;return n<=0?o=s=t=0:(o=Math.floor(n/1e3%60),s=Math.floor(n/1e3/60%60),t=Math.floor(n/36e5)),{total:n,hours:t,minutes:s,seconds:o}};!function(s,t){var n=document.getElementById(s),r=n.querySelector(".hours"),u=n.querySelector(".minutes"),c=n.querySelector(".seconds"),d=setInterval(function(){var s=o(t);r.textContent=e(s.hours),u.textContent=e(s.minutes),c.textContent=e(s.seconds),s.total<=0&&clearInterval(d)},1e3)}("timer","2018-11-5")}},"./src/js/parts/valid.js":
/*!*******************************!*\
  !*** ./src/js/parts/valid.js ***!
  \*******************************/
/*! exports provided: default */function(e,o,s){"use strict";s.r(o);s(/*! core-js/modules/es6.regexp.match */"./node_modules/core-js/modules/es6.regexp.match.js"),s(/*! core-js/modules/web.dom.iterable */"./node_modules/core-js/modules/web.dom.iterable.js");o.default=function(){var e=document.querySelectorAll('input[type="tel"]'),o="_",s="+7 (".concat(o).concat(o).concat(o,") ").concat(o).concat(o).concat(o," ").concat(o).concat(o," ").concat(o).concat(o);function t(e){e.test(event.key)||event.preventDefault()}e.forEach(function(e){e.addEventListener("keypress",function(e){var o=e.target;o.value.length<1||0==o.selectionStart?t(/\+/):o.value.length>0&&t(/\d/)}),e.addEventListener("focus",function(e){var t=e.target;t.value||(t.value=s),t.selectionStart=s.indexOf(o),t.setAttribute("maxlength",s.length)}),e.addEventListener("blur",function(e){var t=e.target;(t.value.match(o)||t.value.length<s.length)&&(t.value="")}),e.addEventListener("input",function(e){var t,n=e.target;t=n.value.substring(0,n.selectionStart)+s.substring(n.selectionStart),n.value=t,n.selectionStart=t.indexOf(o)})})}},"./src/js/script.js":
/*!**************************!*\
  !*** ./src/js/script.js ***!
  \**************************/
